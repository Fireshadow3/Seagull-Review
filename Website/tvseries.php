...
<html lang="en">
    <head>
        ...
        <!-- Custom CSS -->
        <link rel="stylesheet" type="text/css" href="WebsiteThemes/CUSTOM.css">
    ...
    <body class="bg-dark">
        ...
        <div class="container w-50 mt-3 rounded h-50 bg-div">
            <form class="form-inline my-2 my-lg-0 justify-content-center">
              <input class="form-control mr-sm-2 mt-1 mb-1" type="search" placeholder="Search" aria-label="Search">
