...
INSERT INTO recensione(idRecensione,FK_utente,voto,commento,FK_elemento) VALUES		
...
INSERT into serietv_artista (FK_serietv,FK_artista) VALUES
(1,1),
(2,2),
(3,2)

INSERT into serietv_regista(FK_serietv,FK_artista) VALUES
(3,3),
(1,4),
(2,3)

INSERT into lista (idLista,FK_utente,FK_elemento) VALUES
(1,"culo",1),
(2,"nando",1),
(3,"nando",3)
